...
ActiveRecord::Schema[7.1].define(version: 2026_03_30_160000) do
  ...
  create_table "daily_stats", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.date "stat_date", null: false
    t.bigint "homepage_views", default: 0, null: false
    t.bigint "top_stocks_views", default: 0, null: false
    t.bigint "new_users_count", default: 0, null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["stat_date"], name: "index_daily_stats_on_stat_date", unique: true
  end
  ...
  create_table "setting_stock_insights", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.integer "advancing"
    t.integer "declining"
    t.decimal "pct_above_ma50", precision: 20, scale: 10
    t.decimal "pct_above_ma100", precision: 20, scale: 10
    t.decimal "pct_above_ma200", precision: 20, scale: 10
    t.decimal "vnindex_close", precision: 20, scale: 10
    t.decimal "vnindex_ma200", precision: 20, scale: 10
    t.decimal "index_pct", precision: 20, scale: 10
  ...
  create_table "users", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.index ["reset_password_expires"], name: "index_users_on_reset_password_expires"
